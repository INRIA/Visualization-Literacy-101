...
function drawBLANKENVIRONMENT(){
	...
	if(_trial == 0){ // DRAW TABLE
		...
		}else if(_environment.Layout=="rel"){
			drawCOMPAREBROKENLINECHART(_set,_countries,_date_format,_y_axis,"blank",0,0,_planets);
		}else if(_environment.Layout=="abs"){
			drawSAMECOMPAREBROKENLINECHART(_set,_countries,_date_format,_y_axis,"blank",0,0,_planets);
		}
...
function drawENVIRONMENT(data){
	...
	if(_trial == 0){ // DRAW TABLE
		...
		if(_environment.Layout=="single"){
			...
			drawCOMPAREBROKENLINECHART(_set,_countries,_date_format,_y_axis,null,0,0,_planets);
		}else if(_environment.Layout=="abs"){
			drawSAMECOMPAREBROKENLINECHART(_set,_countries,_date_format,_y_axis,null,0,0,_planets);
		}
...
function endSTUDY(){
	...
	setTimeout(function(){
		window.location = "end.php?id="+sessionId;
	},2000);
